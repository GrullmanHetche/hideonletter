...
export const dialogues: Dialogue[] = [
  ...
  },
  {
    ...
    featured: true,
    messages: [
      { side: "right", sender: "현", text: "돈 마니 벌어서 울 고냐니 호강시켜 줘야지." },
      { side: "right", sender: "현", text: "맨날 하이디라오 보내 주고." },
      { side: "left", sender: "혁", text: "그런 걸 제가 받아도 괜찮은 건가요?" },
      { side: "left", sender: "혁", text: "음." },
      { side: "right", sender: "현", text: "당연하죠!" },
      { side: "left", sender: "혁", text: "조금 뜬금없는 질문인데요." },
      { side: "right", sender: "현", text: "아님 나 돈 벌 이유 업슴." },
      { side: "right", sender: "현", text: "네? 네." },
      { side: "left", sender: "혁", text: "유현 씨가 좋아한다던 사람이 저인가요?" },
      { side: "right", sender: "현", text: "에?" },
      { side: "left", sender: "혁", text: "아니, 뭔가......이런 말을 친구 사이에 하지는 않을 것 같아서요." },
      { side: "left", sender: "혁", text: "제가 너무 이상한 소리를 했나요." },
      { side: "right", sender: "현", text: "아니 모 뜬금이 없긴 한데…" },
      { side: "right", sender: "현", text: "그럼 아니라고 생각하셨던 거예요?" },
      { side: "left", sender: "혁", text: "제가 아니라 다른 사람이지 않을까 생각했습니다." },
      { side: "left", sender: "혁", text: "전 바쁘고, 해외도 자주 나가야 하고, 유현 씨 곁에 있는 시간도 적을 테니까요." },
      { side: "left", sender: "혁", text: "시간을 많이 써주는 사람과 연애하는 게 좋다고들 하던데 저는......그런 점에서는 영 좋은 사람은 아니죠." },
      { side: "right", sender: "현", text: "ㄱ- 애초에 그런 걸 따져가며 좋아하는 편도 아니구." },
      { side: "right", sender: "현", text: "근데 뭐… 제가 좋아하는 게 상혁 씨라고 해서 뭔가 달라지나요." },
      { side: "right", sender: "현", text: "이상혁을 좋아하는 팬+1인 거죠." },
      { side: "left", sender: "혁", text: "아. 음." },
      { side: "left", sender: "혁", text: "팬심인가요?" },
      { side: "left", sender: "혁", text: "하지만 팬심은 전부 일방적인 걸요." },
      { side: "left", sender: "혁", text: "유현 씨가 저를 그만 좋아하고, 저에게 연락하지 않으면 끝나는 관계가 팬이라면..." },
      { side: "left", sender: "혁", text: "저는 그러고 싶지 않습니다." },
      { side: "right", sender: "현", text: "아니 머, 저 그 머냐. 암튼 머시기." },
      { side: "left", sender: "혁", text: "유현 씨를 오래 보고 싶어요." },
      { side: "left", sender: "혁", text: "그러기 위해서 달라져야 한다고 하면 저는 달라지고 싶습니다." },
      { side: "left", sender: "혁", text: "너무 무리한 부탁인가요?" },
      { side: "right", sender: "현", text: "무리한 부탁이라기 보다는. 음." },
      { side: "right", sender: "현", text: "아니 어차피 머냐 그거잖아요. 더 좋아하는 쪽이 진다구. 제가 무슨 힘이 있나요." },
      { side: "right", sender: "현", text: "대충 하루에 서너 번 연락만 해도 좋아 죽는 사람인데, 저는···" },
      { side: "left", sender: "혁", text: "저도 다르지 않습니다." },
      { side: "left", sender: "혁", text: "연락하지 않으면 생각이 납니다." },
      { side: "left", sender: "혁", text: "좋아하면 다 그런 거 아닌가요." },
      { side: "left", sender: "혁", text: "좋아한다고 말하는 것도 자격이 없는 것 같아서 망설이는 거면 더 좋아하는 게 아닌가요." },
      { side: "right", sender: "현", text: "사실 제 생각을… 하시는 줄은 몰랐는데." },
      { side: "right", sender: "현", text: "지금 고백하시는 건가요?" },
      { side: "left", sender: "혁", text: "음." },
      { side: "left", sender: "혁", text: "아니라고 말하기에는 너무 많은 걸 말한 것 같네요." },
      { side: "left", sender: "혁", text: "죄송합니다. 하지만..." },
      { side: "left", sender: "혁", text: "줄곧 생각했습니다. 자격이 없고 그럴 만한 관계가 아니라고 생각해서 말하지 못했지만요. 그래도 언젠가 사라질 관계라면 조금 더 단단하게 묶이고 싶습니다. 그게 사회에서 말하는 연인이나 부부라는 단어여도 상관 없을 것 같아요." },
      { side: "left", sender: "혁", text: "고백치고는 너무 멋이 없나요. 처음 쓰는 말이어서 그런 것 같습니다." },
      { side: "right", sender: "현", text: "심장이 너무 소란스러워서 무슨 말을 해야 할지 모르겠어요." },
      { side: "left", sender: "혁", text: "편하게......대답해주세요." },
      { side: "left", sender: "혁", text: "저도 조금 당황스러울 정도로 말한 것 같아 마음이 쓰입니다." },
      { side: "right", sender: "현", text: "편하든 불편하든 제 대답은 무조건 좋아요인 걸요. 사실 얼굴이 너무 뜨거워진 것 말고는 불편한 것 하나 없지만요." },
      { side: "left", sender: "혁", text: "이제 제 얼굴도 뜨거워졌으니까 같이 불편해도 됩니다." },
      { side: "right", sender: "현", text: "진짜 어이없어." },
    ],
  },
];
